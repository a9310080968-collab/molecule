...
try {
    ...
    try {
        ...
        const organization = await client.query(`INSERT INTO organizations (slug, name)
       VALUES ($1, $2)
       ON CONFLICT (slug) DO UPDATE SET name = EXCLUDED.name
       RETURNING id`, [organizationSlug, organizationName]);
       ...
       VALUES ($1, $2, $3)`, [organization.rows[0]?.id, user.rows[0]?.id, role]);
